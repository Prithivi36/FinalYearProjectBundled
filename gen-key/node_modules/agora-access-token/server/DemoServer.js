...
http.createServer(app).listen(app.get('port'), function() {
    console.log('AgoraSignServer (HTTP) starts at ' + app.get('port'));
});

https.createServer(sslOptions, app).listen(8082, function() {
    console.log('AgoraSignServer (HTTPS) starts at 8082');
});
